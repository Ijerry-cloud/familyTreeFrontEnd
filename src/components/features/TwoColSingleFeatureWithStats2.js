    ...
    <Container>
      <TwoColumn css={!imageInsideDiv && tw`md:items-center`}>
        <ImageColumn css={imageContainerCss}>
          {imageInsideDiv ? <Image imageSrc={imageSrc} css={imageCss} /> : <img style={{maxWidth : '100%', height: 'auto', display: 'block', verticalAlign: 'middle'}} src={imageSrc} css={imageCss} alt="" />}
